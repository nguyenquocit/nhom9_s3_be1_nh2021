        ...
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="form-group">
                ...
                <input type="text" id="inputName" class="form-control" name="id" value ="<?php echo $valuee['id'] ?>" >
              </div>
              <div class="form-group">
                <label for="inputName">Name</label>
                <input type="text" id="inputName" class="form-control" name="name" value ="<?php echo $valuee['name'] ?>" >
              </div>
              <div class="form-group">
