                ...
                ?>
                  <tr>
                      ...
                      <td class="project-actions ">
                          ...
                          <a class="btn btn-info btn-sm" href="edittype.php?type_id=<?php echo $value['type_id'] ?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <a class="btn btn-danger btn-sm" href="deltype.php?type_id=<?php echo $value['type_id'] ?>">
